        ...
        <div className="relative z-10 mx-auto w-full max-w-5xl flex flex-col items-center gap-10">
          ...
          <div className="space-y-4 text-center max-w-3xl">
            <h1 className="text-4xl sm:text-6xl md:text-[76px] font-normal leading-[1.08] tracking-tight text-white drop-shadow-[0_4px_24px_rgba(0,0,0,0.85)]">
              <span className="font-display block italic font-light tracking-wide text-zinc-100">Kreatif, Kolaboratif</span>
              <span className="font-sans font-black uppercase bg-gradient-to-b from-white via-zinc-100 to-zinc-400 bg-clip-text text-transparent">&amp; Berdaya Saing Global</span>
            </h1>
