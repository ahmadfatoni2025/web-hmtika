...
export default function Navbar() {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 w-full bg-gradient-to-b from-black/60 to-transparent">
      ...
      {/* ─── Sidebar Menu Panel (Menggunakan OptionWheel) ─── */}
      <div
      ...
      >
        ...
        <div className="flex flex-col justify-between h-full px-8 py-20 relative">
          ...
          <div className="flex-1 flex flex-col justify-center min-h-[300px] mt-8 overflow-hidden relative">
            <p
            ...
            <div
              className={`flex-1 w-full h-[320px] transition-all duration-700 transform ${menuOpen ? "translate-x-0 opacity-100" : "translate-x-20 opacity-0"
                }`}
                ...
                <OptionWheel
                  ...
                  draggable
                   onChange={(index: number) => {
                    // Berikan sedikit delay agar transisi wheel selesai sebelum pindah halaman
                    setTimeout(() => {
