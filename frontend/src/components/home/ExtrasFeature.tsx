...
export default function ExtrasFeature() {
  ...
  const [activeTab, setActiveTab] = useState<"aspirasi" | "event">("aspirasi")
      ...
      <div className="mx-auto max-w-6xl flex flex-col items-center gap-12">
        ...
        <div className="w-full">
          <div className="flex items-center justify-center mb-8">
            <div className="inline-flex items-center gap-1.5 p-1 rounded-full bg-white/[0.03] border border-white/[0.06] relative">
              <button
                onClick={() => setActiveTab("aspirasi")}
                className={`relative inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full px-5 py-2 text-xs font-semibold transition-colors duration-200 cursor-pointer ${activeTab === "aspirasi" ? "text-white" : "text-zinc-400 hover:text-zinc-200"
                  }`}
              >
                {activeTab === "aspirasi" && (
                  <motion.span
              ...
              <button
                ...
                className={`relative inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full px-5 py-2 text-xs font-semibold transition-colors duration-200 cursor-pointer ${activeTab === "event" ? "text-white" : "text-zinc-400 hover:text-zinc-200"
                  }`}
              >
                {activeTab === "event" && (
                  <motion.span
